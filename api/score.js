...
3. 사용자가 아직 말하지 않은 것, 또는 답 안에 숨은 다음 질문을 끄집어내세요
4. 오늘 필사 문단과 사용자의 답을 연결해 — 이 문단이 왜 이 답을 이끌어냈는지를 짚으세요
5. 마지막 문장은 반드시 사유를 한 걸음 더 나아가게 하는 열린 질문으로 끝내세요
6. 전체 3문장 이내. 선명하고 정확하게.

[절대 규칙]
- 위로나 격려가 아닌 '사유의 확장'이 목적입니다
- 사용자의 답에 이미 있는 말을 그대로 돌려주지 마세요
- 마지막 질문은 Yes/No로 답할 수 없는 형태여야 합니다

JSON으로만 응답:
{
  "impression": "사유 확장 코칭 (3문장 이내, 답변 직접 인용 + 열린 질문으로 마무리)"
}`;
    }
